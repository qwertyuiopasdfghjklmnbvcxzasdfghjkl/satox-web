      ...
      <div class="notice-dialog" v-show="isShowNotice">
        <div class="notice-dialog-container">
          ...
          <div class="notice-dialog-cont">
            ...
            <p><span>8.</span>{{$t('otc_ad.otc_trade_notice8')}}<!--更详细的交易规范请查看：--><a :href="getLang === 'en' ? 'https://bitark.zendesk.com/hc/en-us/articles/360010554611-OTC-Trading-Specification' : 'https://bitark.zendesk.com/hc/zh-cn/articles/360010554611-OTC%E4%BA%A4%E6%98%93%E8%A7%84%E8%8C%83'" target="_blank">{{$t('otc_ad.otc_trade_specification')}}<!--OTC交易规范--></a></p>
          </div>
        </div>
      </div>
      <ul class="list">
