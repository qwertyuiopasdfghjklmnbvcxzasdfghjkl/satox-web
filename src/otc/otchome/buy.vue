...
.cancel{box-sizing: border-box;color: #333;border: 1px solid #ccc;}
.cancel:hover{color: #111;border-color: #bbb;}
.cimfir{color: #fff;background-color: #3283FF;}
.cimfir:hover{background-color: #2565c5;}
