    ...
    <div class="business-panel" :class="{unfold:isShow}">
        ...
        <div class="business-panel-form" v-show="isShow">
            <div class="business-panel-left">
                <business ref="business_buy" :active="active" tradeType="buy" :accuracy="accuracy" :fixedNumber="fixedNumber" :baseSymbol="baseSymbol" :currentSymbol="currentSymbol" :toFixed="toFixed" :fromWallet="fromWallet" :toWallet="toWallet" :marketList="marketList"/>
            </div>
            <div class="business-panel-right">
                <business ref="business_sell" :active="active" tradeType="sell" :accuracy="accuracy" :fixedNumber="fixedNumber" :baseSymbol="baseSymbol" :currentSymbol="currentSymbol" :toFixed="toFixed" :fromWallet="fromWallet" :toWallet="toWallet" :marketList="marketList"/>
            </div>
        </div>
    </div>
</template>
...
export default {
  props: ['accuracy', 'fixedNumber', 'baseSymbol', 'currentSymbol', 'toFixed', 'fromWallet', 'toWallet', 'marketList'],
  components: {
    business
  },
  data () {
