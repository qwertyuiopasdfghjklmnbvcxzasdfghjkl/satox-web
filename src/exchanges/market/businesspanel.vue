    ...
    <div class="business-panel" :class="{unfold:isShow}">
        ...
        <div class="business-panel-form" v-show="isShow">
            <div class="business-panel-left">
                <business ref="business_buy" :active="active" tradeType="buy" :fixedNumber="fixedNumber" :Quantityaccu="Quantityaccu" :Amountaccu="Amountaccu" :baseSymbol="baseSymbol" :currentSymbol="currentSymbol" :toFixed="toFixed" :fromWallet="fromWallet" :toWallet="toWallet" :buyToWallet="buyToWallet" :marketList="marketList"/>
            </div>
            <div class="business-panel-right">
                <business ref="business_sell" :active="active" tradeType="sell" :fixedNumber="fixedNumber" :Quantityaccu="Quantityaccu" :Amountaccu="Amountaccu" :baseSymbol="baseSymbol" :currentSymbol="currentSymbol" :toFixed="toFixed" :fromWallet="fromWallet" :toWallet="toWallet" :buyToWallet="buyToWallet" :marketList="marketList"/>
            </div>
        </div>
    </div>
</template>
...
export default {
  props: ['fixedNumber','Quantityaccu','Amountaccu', 'baseSymbol', 'currentSymbol', 'toFixed', 'fromWallet', 'toWallet', 'buyToWallet', 'marketList'],
  components: {
    business
  },
  data () {
