...
<style scoped>
.coininfo{position:absolute;z-index:10;top:0;left:0;width:100%;height:0;background-color:#fff;transition:300ms;overflow:hidden;display:flex;flex-flow:column;}
