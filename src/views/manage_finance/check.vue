...
export default {
    ...
    methods: {
        ...
        audit(code) {
            if (this.formItem.checkbox === true) {
                if (this.formItem.textarea != '') {
                    ...
                    this.$Message.error({content: '请输入备注'})
                }
            } else {
                this.$Message.error({content: '请选择电话确认'})
            }
...
<style scoped>
.ivu-form /deep/ .ivu-form-item-label{text-align: left !important;width: 100px !important;}
.ivu-form-item-content{margin-left: 100px  !important;}
</style>
