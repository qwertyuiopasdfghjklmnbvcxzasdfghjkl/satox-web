    ...
    <Tabs>
        <TabPane label="币币交易参数">
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
               <InputNumber :min="0" v-model="transactionRate"></InputNumber>
              <!-- <Input placeholder="单行输入" style="width:200px" :min="1" v-model="transactionRate"></Input> -->
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="kycCount"></Input> -->
              <InputNumber :min="0" v-model="kycCount"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="ipCount"></Input> -->
              <InputNumber :min="0" v-model="ipCount"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="apiCount"></Input> -->
              <InputNumber :min="0" v-model="apiCount"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="minQuota"></Input> -->
              <InputNumber :min="0" v-model="minQuota"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="tradeLimitDays"></Input> -->
              <InputNumber :min="0" v-model="tradeLimitDays"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="entrustDepth"></Input> -->
              <InputNumber :min="0" v-model="entrustDepth"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="nicknameUpdateCount"></Input> -->
              <InputNumber :min="0" v-model="nicknameUpdateCount"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="headUpdateCount"></Input> -->
              <InputNumber :min="0" v-model="headUpdateCount"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="upPwdLimitTime"></Input> -->
              <InputNumber :min="0" v-model="upPwdLimitTime"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="extractQuotaDay"></Input> -->
              <InputNumber :min="0" v-model="extractQuotaDay"></InputNumber>
        ...
        <TabPane label="OTC交易设置">
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="otcTransactionRate"></Input> -->
               <InputNumber :min="0" v-model="otcTransactionRate"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="overtimeWarningTime"></Input> -->
               <InputNumber :min="0" v-model="overtimeWarningTime"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="excessWarningAmount"></Input> -->
               <InputNumber :min="0" v-model="excessWarningAmount"></InputNumber>
              <Button type="primary" style="margin-left:10px;" @click="updataSystem('excessWarningAmount')">修改</Button>
            </Col>
          </Row>
          <Row>
            <Col span="12"> OTC币种</Col>
            <Col span="5">
              <div style="width:50px;background:transparent;border:1px solid transparent"></div>
          ...
          <Row style="margin-bottom:10px;border:1px solid rgb(221, 222, 225);height:30px;line-height:30px;">
            <CheckboxGroup v-model="otcCoinType" @on-change="updataSystem('otcCoinType')">
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="adCountLimit"></Input> -->
               <InputNumber :min="0" v-model="adCountLimit"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="cancelOrderCountLimit"></Input> -->
               <InputNumber :min="0" v-model="cancelOrderCountLimit"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <Input  style="width:80px" :min="0" v-model="priceBasePlatform"></Input>
               <!-- <InputNumber :min="0" v-model="priceBasePlatform"></InputNumber> -->
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="oneAdMaxConcurrency"></Input> -->
               <InputNumber :min="0" v-model="oneAdMaxConcurrency"></InputNumber>
          ...
          <Row style="margin-bottom:10px;">
            ...
            <Col span="12">
              <!-- <Input placeholder="单行输入" style="width:200px" :min="0" v-model="userTransactMaxConcurrency"></Input> -->
               <InputNumber :min="0" v-model="userTransactMaxConcurrency"></InputNumber>
