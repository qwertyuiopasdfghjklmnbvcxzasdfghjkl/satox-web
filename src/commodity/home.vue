    ...
    <div class="home">
      <div class="center">
        ...
        <div class="home-center">
          <div class="home-center-top">
            <div class="top-left-header">
              <ul style="margin-right:80px;">
                <li class="last-item">
                  <p class="fs18" style="line-height: 0.9;">
                    {{currentSymbol}}<br>
                    <span class="fs12">{{$t(`symbol.${currentSymbol}`)}}</span>
                  </p>
                </li>
              </ul>
          ...
          <div class="home-center-bottom" v-show="false">
            <businesspanel ref="businesspanel" v-show="!isEntrust" :fixedNumber="fixedNumber" :Quantityaccu="Quantityaccu" :Amountaccu="Amountaccu" :baseSymbol="baseSymbol" :currentSymbol="currentSymbol" :toFixed="toFixed" :fromWallet="fromWallet" :toWallet="toWallet" :buyToWallet="buyToWallet" :sellToWallet="sellToWallet" :marketList="marketList"/>
        ...
        <div class="home-right" v-show="false">
...
<script>
import left from '@/commodity/market/market'
import market from '@/commodity/market'
import depth from '@/commodity/market/depth'
import lastdeal from '@/commodity/market/lastdeal'
import entrust from '@/commodity/market/entrust'
import businesspanel from '@/commodity/market/businesspanel'
...
export default {
  ...
  methods: {
    ...
    changeSymbol (baseSymbol, currentSymbol) {
      ...
      this.$router.push({name: 'commodity_index', params: {symbol: `${currentSymbol}_${baseSymbol}`}})
    },
    showCoinInfo () {
      this.tiggerEvents({
        name: 'klineEvent',
