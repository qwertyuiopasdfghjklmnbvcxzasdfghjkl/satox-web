            ...
            <div class="login-right">
                <div class="login-right-item item-findpwd">
                    ...
                    <template v-if="registerType==1">
                      ...
                      <inputbox id="bitark-password" v-validate="'required|password'" type="password" name="password" :msgs="msgs.password" :errs="errors" v-model="mobileFormData.password" :title="$t('account.user_center_new_password')" :placeholder="$t('account.user_center_Please_new_password')"/><!--新密码-->
