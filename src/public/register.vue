...
.login-right-item /deep/ .input{width: 100% !important;height:38px;margin: 0;padding: 0;font-size: 16px;line-height: normal;color: #d6dff9;background-color: transparent;border-width: 0;border-bottom: 1px solid #404b69;outline: none;}
...
.mobile /deep/ select{position: absolute;top: 0;left: 0;z-index: 1;width: 120px;height: 38px;padding-right: 20px;color: #404b69;background-position: right 4px center;}
