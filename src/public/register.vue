            ...
            <div class="login-right">
                <div class="login-right-item item-register">
                    ...
                    <div class="button-group">
                        ...
                        <div class="link">
                            <a href="javascript:;" @click="loginDialog" v-html="$t('login_register.Already_registered_Login').format(`<font color='#fdb902'>NEWTON</font>`)"><!--已有NEWTON账号，请登录--></a>
                        </div>
                    </div>
                </div>
            </div>
...
.login-right-item .button-group .link a{height: 24px;line-height: 24px;color: #d6dff9;text-decoration: underline;}
...
.smsCode /deep/ a{position: absolute;top: 34px;right: 0;height: 22px;line-height: 22px;color: #fdb902;}
