<template>
  <div class="dialog">
      ...
      <div class="form">
        ...
        <inputbox id="bitark-password" v-validate="'required|password'" type="password" name="password" :msgs="msgs.password" :errs="errors" v-model="formData.password" :title="$t('account.user_center_new_password')"/><!--新密码-->
...
.alink{color: #0066cc;font-size: 12px;text-decoration: underline;}
.alink:hover{color: #15c9ff;}
