    ...
    <div class="authencation2">
        <form ref="form" onsubmit="return false">
            ...
            <div class="form-row">
                ...
                <div class="row-description">{{$t('public0.public103').format('NEWTON')}}<!--请您上传一张手持证件及写有“NEWTON”和当天日期的卡片的照片。请确保头像、证件内容、卡片上NEWTON和当天日期内容清晰可见。--></div>
            </div>
...
import diagramFront from '@/assets/images/hzzm.png'
import diagramBack from '@/assets/images/sfzzm.png'
...
<style scoped>
.authencation2{padding: 10px 8px 40px 8px;}
...
.form-row .row-text{float: left;width: 290px;height: 28px;color: #becbe8;background-color: #FFF;border: 1px solid #505e83;}
.form-row .row-text.error{border-color: #e53f3f;}
.form-row .row-select{float: left;width: 300px;height: 30px;padding-left: 4px;padding-right: 20px;color: #becbe8;background-position: right 4px center;border: 1px solid #505e83;background-color:#FFF;}
