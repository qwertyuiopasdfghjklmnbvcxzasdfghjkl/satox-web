    ...
    <div class="authencation2">
        <form ref="form" onsubmit="return false">
            ...
            <div class="form-row">
                ...
                <div class="row-description">{{$t('public0.public103').format('Bitark')}}<!--请您上传一张手持证件及写有“Bitark”和当天日期的卡片的照片。请确保头像、证件内容、卡片上Bitark和当天日期内容清晰可见。--></div>
            </div>
...
.form-row .row-select{float: left;width: 300px;height: 30px;padding-left: 4px;padding-right: 20px;color: #becbe8;background-position: right 4px center;border: 1px solid #505e83;}
