...
.withAdress ul li{line-height: 30px;font-size: 12px;color: #fff;text-indent: 12px;background-color: #BA8D35;cursor: pointer; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;}
